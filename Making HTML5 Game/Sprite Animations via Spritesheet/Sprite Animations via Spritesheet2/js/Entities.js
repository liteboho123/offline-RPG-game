...
else if(self.aimAngle >= 135 && self.animAngle < 225){
directionMod = 1;
}
else if(self.aimAngle >= 225 && self.animAngle < 315){
directionMod = 0;
}

// ctx.drawImage(Image, cropImagestartx, cropImagestarty, cropImagewidth, cropImageheight, drawCanvasX, drawCanvasY, drawCanvasWidth, drawCanvasHeight);
ctx.drawImage(self.img, 0, directionMod*frameHeight, frameWidth, frameHeight, x, y, self.width, self.height);
